...
class _RepMessageParserScreenState extends State<RepMessageParserScreen>
  ...
  void _parseMessage() async {
    ...
    final curPattern =
        r'(?:ج\.م|ر\.س|د\.إ|د\.ك|ر\.ق|د\.ب|ر\.ع|د\.ع|د\.أ|د\.ل|ج\.س|ر\.ي|ل\.س|ل\.ل|ش\.ج|د\.م\.?|د\.ج|د\.ت|ش\.ص|ف\.ج\.ق|ف\.ج|جنيهات|جنيه|دراهم|درهم|ريالات|ريال|دنانير|دينار|ليرات|ليرة|شواكل|شيكل|أوقية|فرنكات|فرنك|شلنات|شلن|EGP|SAR|AED|KWD|QAR|BHD|OMR|IQD|JOD|LYD|SDG|YER|SYP|LBP|ILS|MAD|DZD|TND|MRU|SOS|DJF|KMF)';
