        ...
        children: [
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      const Text('تنبيه ذكي', style: TextStyle(color: AppColors.primary, fontWeight: FontWeight.w700, fontSize: 13)),
          ...
          Row(
            children: [
              ...
              StatCard(icon: '✅', value: '$covered', label: 'تمت التغطية', valueColor: AppColors.primary),
            ],
          ),
          ...
          Row(
            children: [
              StatCard(icon: '⚠️', value: '$stubborn', label: 'مستعصية', valueColor: AppColors.danger),
              const SizedBox(width: 10),
              StatCard(
                icon: '📈',
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    const Text('معدل التغطية اليوم', style: TextStyle(color: AppColors.textLight, fontWeight: FontWeight.w600, fontSize: 13)),
                    Text('${(rate * 100).toStringAsFixed(0)}%', style: const TextStyle(color: AppColors.primary, fontWeight: FontWeight.w800)),
                  ],
                ),
                const SizedBox(height: 10),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [AppColors.danger.withValues(alpha: 0.15), AppColors.darkCard],
                begin: Alignment.topLeft,
                end: Alignment.bottomRight,
              ),
              borderRadius: BorderRadius.circular(16),
            ...
            child: Row(
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('إجمالي ديون العملاء', style: TextStyle(color: AppColors.textMuted, fontSize: 12)),
                    Text(
                      '${_totalDebt.toStringAsFixed(2)} جنيه',
                      style: const TextStyle(color: AppColors.danger, fontSize: 22, fontWeight: FontWeight.w800),
                    ),
                  ],
                ),
              ],
          ...
          // Quick Actions
          const Text('⚡ وصول سريع', style: TextStyle(color: AppColors.textMuted, fontSize: 12, fontWeight: FontWeight.w700)),
          const SizedBox(height: 10),
          GridView.count(
            shrinkWrap: true,
